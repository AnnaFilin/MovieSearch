...
struct ContentView: View {
    ...
    var body: some View {
        TabView(selection: $selectedTab) {
            GalleryView(trendingMovies: viewModel.trendingMovies, popularMovies: viewModel.popularMovies, topRatedMovies: viewModel.topRatedMovies, genres: genres, selectedTab: $selectedTab)
